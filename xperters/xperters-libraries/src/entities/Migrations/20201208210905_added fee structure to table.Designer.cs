...
namespace xperters.entities.Migrations
{
    ...
    [Migration("20201208210905_added fee structure to table")]
    partial class addedfeestructuretotable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("xperters.entities.Entities.FeeStructure", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("BandEnd")
                        .HasColumnType("decimal(18, 2)");
                    ...
                    b.Property<decimal>("FeeFlatRate")
                        .HasColumnType("decimal(18, 2)");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5638432d-e6c9-422b-b52b-16c1aa24420d"),
                            BandEnd = 500m,
                            BandStart = 0m,
                            CreatedDate = new DateTime(2020, 12, 8, 21, 9, 3, 111, DateTimeKind.Utc).AddTicks(7690),
                            Description = "0-500",
                            FeeFlatRate = 20m,
                            FeePercentage = 5m,
                            ModifiedDate = new DateTime(2020, 12, 8, 21, 9, 3, 111, DateTimeKind.Utc).AddTicks(8090)
                        },
                        new
                        {
                            Id = new Guid("d81ca79e-08e8-4bc3-ba9c-af5a047f1427"),
                            BandEnd = 1000m,
                            BandStart = 500m,
                            CreatedDate = new DateTime(2020, 12, 8, 21, 9, 3, 112, DateTimeKind.Utc).AddTicks(650),
                            Description = "500-1000",
                            FeeFlatRate = 15m,
                            FeePercentage = 5m,
                            ModifiedDate = new DateTime(2020, 12, 8, 21, 9, 3, 112, DateTimeKind.Utc).AddTicks(690)
                        },
                        new
                        {
                            Id = new Guid("ffeb9fc9-15b1-4f94-ae8c-b14de2a27edc"),
                            BandEnd = 10000m,
                            BandStart = 1000m,
                            CreatedDate = new DateTime(2020, 12, 8, 21, 9, 3, 112, DateTimeKind.Utc).AddTicks(740),
                            Description = "1000-10000",
                            FeeFlatRate = 10m,
                            FeePercentage = 4m,
                            ModifiedDate = new DateTime(2020, 12, 8, 21, 9, 3, 112, DateTimeKind.Utc).AddTicks(740)
                        },
                        new
                        {
                            Id = new Guid("b50cf5d0-cb99-44ad-b118-0437a78fd330"),
                            BandEnd = 100000m,
                            BandStart = 10000m,
                            CreatedDate = new DateTime(2020, 12, 8, 21, 9, 3, 112, DateTimeKind.Utc).AddTicks(750),
                            Description = "10000-100000",
                            FeeFlatRate = 10m,
                            FeePercentage = 3.5m,
                            ModifiedDate = new DateTime(2020, 12, 8, 21, 9, 3, 112, DateTimeKind.Utc).AddTicks(750)
                        },
                        new
                        {
                            Id = new Guid("952725c1-aa5b-4ac4-a590-07cf8c58e913"),
                            BandEnd = 0m,
                            BandStart = 100000m,
                            CreatedDate = new DateTime(2020, 12, 8, 21, 9, 3, 112, DateTimeKind.Utc).AddTicks(780),
                            Description = ">100000",
                            FeeFlatRate = 10m,
                            FeePercentage = 3m,
                            ModifiedDate = new DateTime(2020, 12, 8, 21, 9, 3, 112, DateTimeKind.Utc).AddTicks(780)
                        });
                });
            ...
            modelBuilder.Entity("xperters.entities.Entities.PaymentTransactionType", b =>
                {
                    ...
                    b.ToTable("PaymentTransactionTypes");
            ...
            modelBuilder.Entity("xperters.entities.Entities.SystemBalance", b =>
                {
                    ...
                    b.Property<decimal>("BalancePrevious")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("xperters.entities.Entities.SystemPayment", b =>
                {
                    ...
                    b.HasIndex("PaymentTransactionTypeId");
            ...
            modelBuilder.Entity("xperters.entities.Entities.UserWithdrawal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("xperters.entities.Entities.SystemPayment", b =>
                {
                    b.HasOne("xperters.entities.Entities.PaymentTransactionType", "PaymentTransactionType")
                        .WithMany("SystemPayments")
                        .HasForeignKey("PaymentTransactionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
