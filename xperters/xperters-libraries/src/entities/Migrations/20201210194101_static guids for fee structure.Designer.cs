...
namespace xperters.entities.Migrations
{
    ...
    [Migration("20201210194101_static guids for fee structure")]
    partial class staticguidsforfeestructure
    {
            ...
            modelBuilder.Entity("xperters.entities.Entities.FeeStructure", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BandEnd = 500m,
                            BandStart = 0m,
                            CreatedDate = new DateTime(2020, 12, 10, 19, 40, 57, 26, DateTimeKind.Utc).AddTicks(3022),
                            Description = "0-500",
                            FeeFlatRate = 20m,
                            FeePercentage = 5m,
                            ModifiedDate = new DateTime(2020, 12, 10, 19, 40, 57, 26, DateTimeKind.Utc).AddTicks(6319)
                        },
                        new
                        {
                            ...
                            BandEnd = 1000m,
                            BandStart = 500m,
                            CreatedDate = new DateTime(2020, 12, 10, 19, 40, 57, 29, DateTimeKind.Utc).AddTicks(815),
                            Description = "500-1000",
                            FeeFlatRate = 15m,
                            FeePercentage = 5m,
                            ModifiedDate = new DateTime(2020, 12, 10, 19, 40, 57, 29, DateTimeKind.Utc).AddTicks(873)
                        },
                        new
                        {
                            ...
                            BandEnd = 10000m,
                            BandStart = 1000m,
                            CreatedDate = new DateTime(2020, 12, 10, 19, 40, 57, 29, DateTimeKind.Utc).AddTicks(1054),
                            Description = "1000-10000",
                            FeeFlatRate = 10m,
                            FeePercentage = 4m,
                            ModifiedDate = new DateTime(2020, 12, 10, 19, 40, 57, 29, DateTimeKind.Utc).AddTicks(1057)
                        },
                        new
                        {
                            ...
                            BandEnd = 100000m,
                            BandStart = 10000m,
                            CreatedDate = new DateTime(2020, 12, 10, 19, 40, 57, 29, DateTimeKind.Utc).AddTicks(1070),
                            Description = "10000-100000",
                            FeeFlatRate = 10m,
                            FeePercentage = 3.5m,
                            ModifiedDate = new DateTime(2020, 12, 10, 19, 40, 57, 29, DateTimeKind.Utc).AddTicks(1071)
                        },
                        new
                        {
                            ...
                            BandEnd = 0m,
                            BandStart = 100000m,
                            CreatedDate = new DateTime(2020, 12, 10, 19, 40, 57, 29, DateTimeKind.Utc).AddTicks(1628),
                            Description = ">100000",
                            FeeFlatRate = 10m,
                            FeePercentage = 3m,
                            ModifiedDate = new DateTime(2020, 12, 10, 19, 40, 57, 29, DateTimeKind.Utc).AddTicks(1640)
                        });
                });
