...
namespace xperters.entities.Migrations
{
    ...
    [Migration("20201208100130_add fees table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("xperters.entities.Entities.Fee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b370a1f6-79e4-429e-aaf8-cdbe397c263b"),
                            BandEnd = 500m,
                            BandStart = 0m,
                            CreatedDate = new DateTime(2020, 12, 8, 10, 1, 28, 198, DateTimeKind.Utc).AddTicks(5040),
                            Description = "0-500",
                            ModifiedDate = new DateTime(2020, 12, 8, 10, 1, 28, 198, DateTimeKind.Utc).AddTicks(5420)
                        },
                        new
                        {
                            Id = new Guid("d77307d8-cb7f-4c66-a196-d8e087eebdd1"),
                            BandEnd = 1000m,
                            BandStart = 500m,
                            CreatedDate = new DateTime(2020, 12, 8, 10, 1, 28, 198, DateTimeKind.Utc).AddTicks(7180),
                            Description = "500-1000",
                            ModifiedDate = new DateTime(2020, 12, 8, 10, 1, 28, 198, DateTimeKind.Utc).AddTicks(7210)
                        },
                        new
                        {
                            Id = new Guid("1caff75a-9413-48a6-bf8f-8872cdd0d7f7"),
                            BandEnd = 10000m,
                            BandStart = 1000m,
                            CreatedDate = new DateTime(2020, 12, 8, 10, 1, 28, 198, DateTimeKind.Utc).AddTicks(7250),
                            Description = "1000-10000",
                            ModifiedDate = new DateTime(2020, 12, 8, 10, 1, 28, 198, DateTimeKind.Utc).AddTicks(7250)
                        },
                        new
                        {
                            Id = new Guid("fde408e1-608d-433e-9a53-0e3ecfe56707"),
                            BandEnd = 100000m,
                            BandStart = 10000m,
                            CreatedDate = new DateTime(2020, 12, 8, 10, 1, 28, 198, DateTimeKind.Utc).AddTicks(7250),
                        ...
                        new
                        {
                            Id = new Guid("aae78db6-0b5b-48d2-9ef0-b96d70a9da70"),
                            BandEnd = 0m,
                            BandStart = 100000m,
                            CreatedDate = new DateTime(2020, 12, 8, 10, 1, 28, 198, DateTimeKind.Utc).AddTicks(7260),
                            Description = ">100000",
                            ModifiedDate = new DateTime(2020, 12, 8, 10, 1, 28, 198, DateTimeKind.Utc).AddTicks(7260)
                        });
                });
