...
namespace xperters.entities.Migrations
{
    ...
    [Migration("20200730143930_milestone status updates")]
    partial class milestonestatusupdates
    {
            ...
            modelBuilder.Entity("xperters.entities.Entities.MilestoneStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            MilestoneStatusId = 4,
                            IsActive = true,
                            StatusDescription = "Admin approved. Milestone funds paid to freelancer account"
                        },
                        new
                        {
                            MilestoneStatusId = 5,
                            IsActive = true,
                            StatusDescription = "Paid after client withdrawal"
                        },
                        new
                        {
                            MilestoneStatusId = 6,
