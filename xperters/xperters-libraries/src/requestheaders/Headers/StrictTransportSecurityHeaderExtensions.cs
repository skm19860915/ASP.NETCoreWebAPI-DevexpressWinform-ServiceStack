...
namespace xperters.requestheaders.Headers
{
    ...
    public static class StrictTransportSecurityHeaderExtensions
    {
        ...
        {
            return policies.AddStrictTransportSecurity(maxAgeInSeconds, includeSubdomains: false, preload: false, excludedHosts: _excludedHosts);
        }
        ...
        {
            return policies.AddStrictTransportSecurity(maxAgeInSeconds, includeSubdomains: true, preload: false, excludedHosts: _excludedHosts);
        }
        ...
        {
            return policies.AddStrictTransportSecurity(maxAgeInSeconds, includeSubdomains: true, preload: true, excludedHosts: _excludedHosts);
        }
        ...
        {
            return policies.AddStrictTransportSecurity(0, includeSubdomains: false, preload: false, excludedHosts: _excludedHosts);
        }
    }
}