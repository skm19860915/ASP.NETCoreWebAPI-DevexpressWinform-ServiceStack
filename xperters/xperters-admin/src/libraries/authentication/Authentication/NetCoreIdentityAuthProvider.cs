...
{
	/// <summary>
	/// We copied this class from https://raw.githubusercontent.com/ServiceStack/ServiceStack/master/src/ServiceStack/Auth/NetCoreIdentityAuthProvider.cs in order to make PreAuthenticate overridable
	/// </summary>
